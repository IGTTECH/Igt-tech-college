...
// ================================
const ADMIN_UIDS = [
  "fONrqafUtqTHlNFSJbsnOl1NGIv1", // Admin 1
  "fONrqafUtqTHlNFSJbsnOl1NGIv1"  // Admin 2
];
...
function login(email, password) {
  auth.signInWithEmailAndPassword(email, password)
    .then(userCredential => {
      ...
      window.location.href = "machapisho.html";
    })
    .catch(error => {
...
function logout() {
  auth.signOut()
    .then(() => {
      ...
      window.location.href = "loginswahili.html"; // redirect to login
    })
    .catch(error => {
